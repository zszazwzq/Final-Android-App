package prototypes;/* -*-mode:java; c-basic-offset:2; indent-tabs-mode:nil -*- */
/**
...
public class ScpTo{
  public static void passFile(String input, String target){
    ...
    try{
      ...
      String rfile=target.substring(target.indexOf(':')+1);
